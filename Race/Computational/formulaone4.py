...
if __name__ == "__main__":
    ...
    if course == "aus":
        ...
        tyre_order = ['medium', 'medium', 'soft', 'medium']
        course = "Spain"
    elif course == "mnc":
        from monaco import *
        course = "Monaco"
        [soft_l_max,med_l_max,hard_l_max] = [16,21,24]
        tyre_order = ['hard', 'soft', 'soft', 'hard']
    elif course == "bel":
        from belgium import *
        course = "Belgium"
        ...
        tyre_order = ['hard', 'soft', 'hard']
    elif course == "hun":
        from hungary import *
        course = "Hungary"
        [soft_l_max,med_l_max,hard_l_max] = [13,17,21]
        tyre_order = ['hard', 'soft', 'hard', 'medium']
    elif course == "usa":
        from usa import *
        course = "USA"
        [soft_l_max,med_l_max,hard_l_max] = [12,13,16]
        tyre_order = ['hard', 'soft', 'hard', 'hard', 'hard', 'hard']
    elif course == "jpn":
        from japan import *
        course = "Japan"
        ...
        tyre_order = ['hard', 'hard', 'hard', 'medium']
    elif course == "brz":
        from brazil import *
        course = "Brazil"
...
if __name__ == "__main__":
    ...
    if len(sys.argv)>2:
        if sys.argv[2] == "--plot":
            ...
            fileString = ("graphs/"+course.lower()+"OptimalRaceAnalytic.png")
